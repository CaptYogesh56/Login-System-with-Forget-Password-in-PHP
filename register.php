        ...
        if(!empty($email) && !empty($password)){
            if($rowCount > 0){
                ...
                if($result){
                    ...
                    $mail->setFrom('MAIL ID', 'OTP Verification');
                    $mail->addAddress($_POST["email"]);
    
                    $mail->isHTML(true);
                    $mail->Subject="Your verification code for Signing Up";
                    $mail->Body="<p>Dear user, </p> <h3>Your verification One Time Password is $otp <br></h3>
                    <br><br>";
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="register.php" style="font-weight:bold; color:black; text-decoration:underline">Sign Up</a>
                </li>
            </ul>
